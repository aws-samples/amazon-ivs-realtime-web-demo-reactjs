...
export const handleMediaToggle = (deviceType, stage, setIsDeviceStopped) => {
  ...
  if (deviceType === CAMERA) {
    ...
    const { videoStream } = stage.current.localParticipant;
  ...
  // If the type is 'mic', toggle the audio stream
    ...
    const { audioStream } = stage.current.localParticipant;
